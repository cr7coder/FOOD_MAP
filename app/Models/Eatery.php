        ...
        $dossiers = [
            'bun-mach-trang-co-loa' => [
                ...
                'timeline' => [
                    ...
                    ['year' => 'Hiện nay', 'event' => 'Được số hóa trên Bản đồ Di sản Ẩm thực Đông Anh để quảng bá ra toàn thế giới.']
                ]
            ],
            'chao-se-gia-truyen-lien-ha' => [
                ...
                'timeline' => [
                    ...
                    ['year' => 'Hiện tại', 'event' => 'Chính thức số hóa trên nền tảng Bản đồ ẩm thực di sản để gìn giữ muôn đời sau.']
                ]
            ],
            'htx-nong-nghiep-duoc-lieu-cong-nghe-cao-kovi' => [
                ...
                'audio_narrative' => 'Chào mừng bạn đến với Không gian số di sản ẩm thực Đông Anh. HTX KOVI là đơn vị tiên phong trong việc nuôi cấy Đông trùng hạ thảo chất lượng cao.',
                'nearby_attractions' => [],
                'timeline' => [
