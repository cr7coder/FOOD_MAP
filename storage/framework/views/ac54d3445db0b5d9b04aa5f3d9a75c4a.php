...
<?php $__env->startSection('meta_description', 'Khám phá ' . $eatery->name . ' tại ' . $eatery->address . ', Xã ' . $eatery->commune->name . ', Đông Anh. Số điện thoại liên hệ: ' . $eatery->phone . '. Thực đơn món đặc sắc: ' . $eatery->dishes->take(2)->pluck('name')->implode(', ') . '. Xem đánh giá khách hàng và bản đồ hướng dẫn đường đi chi tiết.'); ?>
...
<section class="detail-hero" style="background-image: url('<?php echo e($eatery->image_path ?: 'https://images.unsplash.com/photo-1591814468924-caf88d1232e1?auto=format&fit=crop&w=1200&q=80'); ?>')">
    <div class="container detail-hero-content">
        ...
        <p style="font-size: 1.1rem; color: var(--text-main); display: flex; align-items: center; gap: 8px;">
            <span style="font-size: 1.2rem;">📍</span> <?php echo e($eatery->address); ?>
    ...
    <div class="detail-grid">
                    ...
                    <div class="menu-grid">
                        <?php $__currentLoopData = $eatery->dishes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $dish): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="dish-card glass-panel" style="background: rgba(255,255,255,0.02);">
                                <img src="<?php echo e($dish->image_path ?: 'https://images.unsplash.com/photo-1546069901-ba9599a7e63c?auto=format&fit=crop&w=150&q=80'); ?>" class="dish-img" alt="<?php echo e($dish->name); ?>">
                                <div class="dish-info">
                                    <div>
                                        ...
                                        <?php endif; ?>
                                        <h3 class="dish-name"><?php echo e($dish->name); ?></h3>
                                        <p style="font-size: 0.8rem; color: var(--text-muted); margin-top: 4px;"><?php echo e($dish->description); ?></p>
                                    </div>
                                    <span class="dish-price"><?php echo e(number_format($dish->price, 0, ',', '.')); ?>đ</span>
                                </div>
                            </div>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </div>
                        ...
                        <?php $__currentLoopData = $eatery->reviews; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $rev): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="review-item">
                                <div class="review-header">
                                    <div>
                                        <span class="review-user"><?php echo e($rev->user_name); ?></span>
                                ...
                                <p style="font-size: 0.9rem; color: var(--text-main); line-height: 1.6;"><?php echo e($rev->comment); ?></p>
                                    ...
                                    <div style="display: flex; gap: 8px; margin-top: 10px; flex-wrap: wrap;">
                                        <?php $__currentLoopData = $rev->media; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $mediaItem): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <?php if($mediaItem->file_type === 'image'): ?>
                                                <img src="<?php echo e($mediaItem->file_path); ?>" alt="Review Image" style="width: 80px; height: 80px; object-fit: cover; border-radius: 8px; border: 1px solid var(--border-glow);">
                                            <?php else: ?>
                                                <video src="<?php echo e($mediaItem->file_path); ?>" style="width: 80px; height: 80px; object-fit: cover; border-radius: 8px; border: 1px solid var(--border-glow);" controls></video>
                                            <?php endif; ?>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    </div>
                                <?php endif; ?>
        ...
        <aside>
                ...
                <ul class="widget-info-list">
                    <li class="widget-info-item" style="padding: 10px; border-radius: 12px; transition: all 0.3s ease;" onmouseover="this.style.background='var(--bg-btn-secondary)'; this.style.transform='translateX(4px)';" onmouseout="this.style.background='transparent'; this.style.transform='none';">
                        ...
                        <div style="margin-left: 4px;">
                            ...
                            <a href="tel:<?php echo e($eatery->phone); ?>" style="color: var(--text-main); font-weight: 700; font-size: 1.05rem; display: inline-block; margin-top: 2px;"><?php echo e($eatery->phone ?: 'Chưa cập nhật'); ?></a>
                        </div>
                    </li>
                    <li class="widget-info-item" style="padding: 10px; border-radius: 12px; transition: all 0.3s ease;" onmouseover="this.style.background='var(--bg-btn-secondary)'; this.style.transform='translateX(4px)';" onmouseout="this.style.background='transparent'; this.style.transform='none';">
                        ...
                        <div style="margin-left: 4px;">
                            ...
                            <span style="color: var(--text-main); font-weight: 500; display: inline-block; margin-top: 2px;"><?php echo e($eatery->opening_hours ?: 'Đang cập nhật'); ?></span>
                        </div>
                    </li>
                    <li class="widget-info-item" style="padding: 10px; border-radius: 12px; transition: all 0.3s ease;" onmouseover="this.style.background='var(--bg-btn-secondary)'; this.style.transform='translateX(4px)';" onmouseout="this.style.background='transparent'; this.style.transform='none';">
                        ...
                        <div style="margin-left: 4px;">
                            ...
                            <span style="color: var(--accent); font-weight: 700; font-size: 1.05rem; display: inline-block; margin-top: 2px; white-space: nowrap;"><?php echo e($eatery->price_range ?: 'Đang cập nhật'); ?></span>
                        </div>
                    </li>
                    <li class="widget-info-item" style="padding: 10px; border-radius: 12px; transition: all 0.3s ease;" onmouseover="this.style.background='var(--bg-btn-secondary)'; this.style.transform='translateX(4px)';" onmouseout="this.style.background='transparent'; this.style.transform='none';">
                        ...
                        <div style="margin-left: 4px;">
                            ...
                            <span style="font-weight: 800; color: #ffc107; font-size: 1.1rem; display: inline-block; margin-top: 2px; text-shadow: 0 0 10px rgba(255,193,7,0.3);">★ <?php echo e(number_format($eatery->average_rating, 1)); ?> / 5.0</span>
                        </div>
                    </li>
                </ul>
            </div>
            ...
            <div class="sidebar-widget glass-panel">
                ...
                <a href="https://www.google.com/maps/dir/?api=1&destination=<?php echo e($eatery->latitude); ?>,<?php echo e($eatery->longitude); ?>" target="_blank" class="btn-primary" style="width: 100%; justify-content: center; margin-top: 10px; font-size: 0.9rem;">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\FOODDA\FOOD_MAP\resources\views/detail.blade.php ENDPATH**/ ?>