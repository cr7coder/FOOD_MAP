<?php $__env->startSection('title', '👥 Quản lý tài khoản người dùng'); ?>
...
<div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(220px, 1fr)); gap: 16px; margin-bottom: 28px;">
    ...
    <div style="padding: 20px; background-color: #ffffff; border: 1.5px solid var(--admin-border); border-radius: 16px; display: flex; align-items: center; gap: 16px; box-shadow: 0 4px 6px -1px rgba(0, 0, 0, 0.05);">
        ...
        <div>
            ...
            <strong style="font-size: 1.5rem; color: var(--admin-text-main); line-height: 1;"><?php echo e($totalUsers); ?></strong>
        </div>
    </div>
    ...
    <div style="padding: 20px; background-color: #ffffff; border: 1.5px solid var(--admin-border); border-radius: 16px; display: flex; align-items: center; gap: 16px; box-shadow: 0 4px 6px -1px rgba(0, 0, 0, 0.05);">
        ...
        <div>
            ...
            <strong style="font-size: 1.5rem; color: var(--admin-text-main); line-height: 1;"><?php echo e($adminCount); ?></strong>
        </div>
    </div>
    ...
    <div style="padding: 20px; background-color: #ffffff; border: 1.5px solid var(--admin-border); border-radius: 16px; display: flex; align-items: center; gap: 16px; box-shadow: 0 4px 6px -1px rgba(0, 0, 0, 0.05);">
        ...
        <div>
            ...
            <strong style="font-size: 1.5rem; color: var(--admin-text-main); line-height: 1;"><?php echo e($sellerCount); ?></strong>
        </div>
    </div>
    ...
    <div style="padding: 20px; background-color: #ffffff; border: 1.5px solid var(--admin-border); border-radius: 16px; display: flex; align-items: center; gap: 16px; box-shadow: 0 4px 6px -1px rgba(0, 0, 0, 0.05);">
        ...
        <div>
            ...
            <strong style="font-size: 1.5rem; color: var(--admin-text-main); line-height: 1;"><?php echo e($userCount); ?></strong>
        </div>
    </div>
</div>
...
<div class="admin-card">
    ...
    <div style="display: flex; gap: 12px; flex-wrap: wrap; margin-bottom: 20px; align-items: center; justify-content: space-between;">
        <div style="display: flex; gap: 12px; flex-wrap: wrap; flex: 1; min-width: 280px; max-width: 600px;">
            ...
            <div style="position: relative; flex: 1; min-width: 200px;">
                ...
                <input type="text" id="user-search-input" value="<?php echo e(request('search')); ?>" class="admin-form-input" placeholder="Tìm kiếm theo Tên, Email, SĐT..." style="padding-left: 38px; border-radius: 10px; height: 42px; font-size: 0.88rem;">
            </div>
            ...
            <select id="user-status-filter" class="admin-form-input" style="width: 180px; border-radius: 10px; height: 42px; font-size: 0.88rem;">
                ...
                <option value="disabled" <?php echo e(request('status') === 'disabled' ? 'selected' : ''); ?>>Vô hiệu hóa</option>
            </select>
        </div>
    ...
    <div id="users-table-wrapper">
        <?php echo $__env->make('admin.users.partial-table', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
    </div>
</div>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\FOODDA\FOOD_MAP\resources\views/admin/users/index.blade.php ENDPATH**/ ?>