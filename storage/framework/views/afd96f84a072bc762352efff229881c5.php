        ...
        <div style="display: grid; grid-template-columns: 1fr; gap: 40px;">
            ...
            <div>
                ...
                <div class="mood-selector-wrapper">
                    <button class="mood-pill <?php echo e(!$mood ? 'active' : ''); ?>" onclick="filterMood('', this)">
                        <span>🌐</span> Tất cả Lộ trình
                    </button>
                    <button class="mood-pill <?php echo e($mood === 'specialty' ? 'active' : ''); ?>" onclick="filterMood('specialty', this)">
                        <span>🌾</span> Đặc sản xứ Loa
                    </button>
                    <button class="mood-pill <?php echo e($mood === 'chill' ? 'active' : ''); ?>" onclick="filterMood('chill', this)">
                        <span>☕</span> Chill cuối tuần
                    </button>
                    <button class="mood-pill <?php echo e($mood === 'night' ? 'active' : ''); ?>" onclick="filterMood('night', this)">
                        <span>🌙</span> Ăn đêm Cao Lỗ
                    </button>
                    <button class="mood-pill <?php echo e($mood === 'cheap' ? 'active' : ''); ?>" onclick="filterMood('cheap', this)">
                ...
                <div class="tours-grid" id="main-tours-grid">
                    <?php $__currentLoopData = $tours; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tour): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="tour-card animate-fade-in" data-mood="<?php echo e($tour->mood); ?>">
                                <div class="tour-popularity-badge">
                                    <span>⭐</span> <?php echo e($tour->popularity); ?>

                                </div>
                                <div class="tour-thumbnail-wrapper">
                                    <img src="<?php echo e($tour->thumbnail ?: 'https://images.unsplash.com/photo-1591814468924-caf88d1232e1?auto=format&fit=crop&w=800&q=80'); ?>" class="tour-thumbnail" alt="<?php echo e($tour->name); ?>">
                                ...
                                <div class="tour-card-body">
                                    ...
                                    <div style="display: flex; gap: 8px;">
                                        <a href="/food-tour/<?php echo e($tour->slug); ?>" class="btn-primary" style="flex: 1.5; text-align: center; text-decoration: none; padding: 12px; border-radius: 12px; font-weight: 700; display: block; box-shadow: var(--shadow-glow); display: flex; align-items: center; justify-content: center;">
                                            🚀 Trải nghiệm
                                        </a>
                                    ...
                                    <?php else: ?>
                                    <a href="/food-tour/<?php echo e($tour->slug); ?>" class="btn-primary" style="text-align: center; text-decoration: none; width: 100%; padding: 12px; border-radius: 12px; font-weight: 700; display: block; box-shadow: var(--shadow-glow);">
            ...
            <div style="margin-top: 40px;">
                ...
                <div class="tours-grid">
                    ...
                    ?>
                    <div class="tour-card animate-fade-in" data-mood="<?php echo e($cTour->mood); ?>" style="position: relative; border: 1.5px solid rgba(255,126,41,0.2);">
                        ...
                        <div class="tour-thumbnail-wrapper">
                            <img src="<?php echo e($cTour->thumbnail ?: 'https://images.unsplash.com/photo-1555396273-367ea4eb4db5?auto=format&fit=crop&w=800&q=80'); ?>" class="tour-thumbnail" alt="<?php echo e($cTour->name); ?>">
                            <div class="tour-card-overlay">
        ...
        <div id="communityDiariesModal-<?php echo e($tourData->id); ?>" style="display: none; position: fixed; top: 0; left: 0; width: 100%; height: 100%; background: rgba(15, 23, 42, 0.5); backdrop-filter: blur(12px); -webkit-backdrop-filter: blur(12px); z-index: 10005; align-items: center; justify-content: center; animation: fadeIn 0.3s ease;">
            <div style="width: 90%; max-width: 650px; max-height: 85vh; display: flex; flex-direction: column; padding: 30px; border-radius: 24px; background: rgba(26, 26, 38, 0.85); backdrop-filter: blur(25px); -webkit-backdrop-filter: blur(25px); border: 1.5px solid rgba(255, 255, 255, 0.1); box-shadow: 0 25px 60px rgba(0, 0, 0, 0.4); color: #ffffff; position: relative;">
                ...
                <h3 style="font-weight: 800; color: #ffffff; font-size: 1.4rem; margin: 0 0 20px 0; display: flex; align-items: center; gap: 12px; border-bottom: 1px solid rgba(255,255,255,0.1); padding-bottom: 16px;">
                    📖 Nhật ký Cộng đồng
                    <span style="font-size: 0.8rem; background: rgba(255,126,41,0.15); border: 1px solid rgba(255,126,41,0.3); color: #ffb03a; padding: 4px 12px; border-radius: 20px; font-weight: 800;"><?php echo e($tourData->diaries_count); ?> đánh giá</span>
                </h3>
...
<?php echo $__env->make('layouts.food-tour', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\FOODDA\FOOD_MAP\resources\views/food-tours/index.blade.php ENDPATH**/ ?>