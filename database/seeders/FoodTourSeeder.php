...
class FoodTourSeeder extends Seeder
{
    public function run(): void
    {
        ...
        $tour5 = FoodTour::create([
            ...
            'description' => 'Hành trình trải nghiệm độc đáo: Tự tay lựa chọn gạo ngon tại Chợ Mạch Tràng, học làm bún tiến vua cùng nghệ nhân và thưởng thức thành quả nóng hổi.',
            'duration' => '4.0 giờ',
            'distance' => '3.8 km',
            'budget' => '180.000đ - 250.000đ/người',
            'difficulty' => '🌾 Trải nghiệm & Tự nấu',
            'best_time' => '07:30 - 11:30',
            ...
            'story' => 'Thay vì chỉ đi thưởng thức các món ăn chín sẵn, hãy đồng hành cùng chúng tôi trong hành trình tìm về cội nguồn hạt gạo Kinh Bắc. Bạn sẽ sắm vai một người dân địa phương thực thụ, ghé chợ mua sắm, tự tay tham gia vào quy trình giã bột ép khuôn bún Mạch Tràng truyền thống dưới sự hướng dẫn của truyền nhân đời thứ 4, và kết thúc bằng một chặng nghỉ ngơi ăn nướng ngói thư thả.'
        ]);
