...
class MarketAndMartSeeder extends Seeder
{
    ...
    {
        // 1. Khởi tạo các danh mục mới
        $categoriesData = [
            [
                'name'        => 'Chợ truyền thống',
                'slug'        => 'cho-truyen-thong',
                'icon'        => '🎪',
                'description' => 'Các khu chợ truyền thống lâu đời, bán đầy đủ nhu yếu phẩm và ẩm thực bình dân.',
            ],
            [
                'name'        => 'Chợ dân sinh',
                'slug'        => 'cho-dan-sinh',
                'icon'        => '🧺',
                'description' => 'Chợ dân sinh len lỏi trong các thôn làng, mang đậm bản sắc văn hóa vùng quê Đông Anh.',
            ],
            [
                'name'        => 'Siêu thị',
                'slug'        => 'sieu-thi',
                'icon'        => '🛒',
                'description' => 'Trung tâm mua sắm hiện đại, đa dạng mặt hàng phục vụ đời sống.',
            ],
            [
                'name'        => 'Cửa hàng tiện ích',
                'slug'        => 'cua-hang-tien-ich',
                'icon'        => '🏪',
                'description' => 'Các chuỗi cửa hàng tiện lợi, tiện ích phục vụ nhanh chóng 24/7.',
            ],
        ];
