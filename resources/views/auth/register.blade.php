...
<div class="container" style="padding: 60px 0; display: flex; justify-content: center; align-items: center; min-height: calc(100vh - var(--header-height) - 160px);">
    <div class="glass-panel" style="width: 100%; max-width: 680px; padding: 40px; box-shadow: 0 15px 35px rgba(0,0,0,0.5);">
            ...
            <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(280px, 1fr)); gap: 16px 20px; margin-bottom: 24px;">
                ...
                <div>
                    <div class="review-form-group" style="margin-bottom: 16px;">
                        ...
                        <input type="text" name="phone" value="{{ old('phone') }}" class="form-input" required placeholder="Ví dụ: 0901234567" style="padding: 11px 16px;">
                    </div>
