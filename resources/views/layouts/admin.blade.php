...
<body style="min-height: 100vh; display: flex; flex-direction: column; background: var(--bg-base); color: var(--text-main); font-family: var(--font-body); margin: 0; padding: 0;">
    ...
    <header class="glass-nav" style="border-bottom: 1.5px solid rgba(255, 126, 41, 0.25); background: rgba(9, 9, 11, 0.8);">
        <div class="container nav-wrapper">
            ...
            <nav>
                <ul class="nav-menu">
                    <li><a href="/admin/dashboard" class="nav-link {{ request()->is('admin/dashboard') ? 'active' : '' }}">📊 Bảng điều khiển</a></li>
                    <li><a href="/admin/eateries/create" class="nav-link {{ request()->is('admin/eateries/create') ? 'active' : '' }}">➕ Thêm địa điểm</a></li>
            ...
            <div class="user-actions">
                ...
                @if(session()->has('user_id'))
                    <span style="font-size: 0.9rem; color: var(--text-muted);">
                        ...
                        (<span style="color: var(--accent);">{{ session('user_role') === 'admin' ? 'Admin' : 'Chủ quán' }}</span>)
                    </span>
